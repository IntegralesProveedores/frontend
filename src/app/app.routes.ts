...
export const routes: Routes = [
  ...
  },
  {
    path: 'orden/exito',
    loadComponent: () =>
      import('./features/order-status/success/success.component').then(
  ...
  },
  {
    path: 'orden/error',
    loadComponent: () =>
      import('./features/order-status/failure/failure.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/order-status/pending/pending.component').then(
