    ...
    <div class="row g-5">
      ...
      <div class="col-lg-4">
        <div class="order-summary-box p-4">
          ...
          <div
            class="summary-row d-flex justify-content-between mb-3 border-bottom pb-3"
          >
            <app-skeleton width="100px" height="0.8rem" />
            <app-skeleton width="70px" height="0.8rem" />
          </div>
          ...
          <div
            class="total-row d-flex justify-content-between align-items-start pt-3 mt-2"
          >
